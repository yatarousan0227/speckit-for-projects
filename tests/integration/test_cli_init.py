...
def test_init_codex_creates_scaffold():
    with runner.isolated_filesystem():
        ...
        assert Path(".specify/templates/commands/debug.md").exists()
        assert Path(".specify/templates/commands/reflect.md").exists()
        ...
        assert Path(".codex/prompts/sdd.debug.md").exists()
        assert Path(".codex/prompts/sdd.implement.md").exists()
        assert Path(".codex/prompts/sdd.reflect.md").exists()
        ...
        assert Path(".agents/skills/speckit-for-projects-debug/SKILL.md").exists()
        ...
        assert Path(".agents/skills/speckit-for-projects-reflect/SKILL.md").exists()
...
def test_init_kiro_alias_creates_prompts_and_skills():
    with runner.isolated_filesystem():
        ...
        assert Path(".kiro/skills/speckit-for-projects-debug/SKILL.md").exists()
        ...
        assert Path(".kiro/skills/speckit-for-projects-reflect/SKILL.md").exists()
